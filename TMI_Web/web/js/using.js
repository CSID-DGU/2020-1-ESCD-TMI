document.getElementById('show').addEventListener('click',show_detail);

var user_name; // 세부내역 사용자명
var stfAry = new Array(); // 물건 배열
var priceAry = new Array(); // 가격 배열 


function show_detail() // 세부내역 보여주기 함수
{
